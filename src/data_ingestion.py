...
def get_load_data_from_entsoe(regions, periodStart, periodEnd, output_path='/media/marek/DATA/HATACON/SE-Europe-Data_Challenge_Template-main/data'):
...
def get_gen_data_from_entsoe(regions, periodStart, periodEnd, output_path='/media/marek/DATA/HATACON/SE-Europe-Data_Challenge_Template-main/data'):
    ...
    for region, area_code in regions.items():
        ...
        for psr_type, df in dfs.items():
            # Save the DataFrame to a CSV file
            df.to_csv(
                f'{output_path}/gen_{region}_{psr_type}.csv', index=False)
...
def parse_arguments():
    parser = argparse.ArgumentParser(
        description='Data ingestion script for Energy Forecasting Hackathon')
    parser.add_argument(
        '--start_time',
    ...
    parser.add_argument(
        '--output_path',
        type=str,
        default='/media/marek/DATA/HATACON/SE-Europe-Data_Challenge_Template-main/data',
